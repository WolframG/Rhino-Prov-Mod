...
var IsLtLock = function(lock) {
    IsLtLock.super_.call(this, lock);
}

system.inherits(IsLtLock, Lock);

IsLtLock.prototype.copy = function() {
    var c = new IsLtLock(this);
    return c;
}

IsLtLock.prototype.isOpen = function(context) {
    throw new Error("IsLtLock: isOpen not implemented for this ContractLock");
    ...
    if(context) {
        ...
        if((this.args[0].type && this.args[0].type !== 'const') || (this.args[1].type && this.args[0].type !== 'const'))
		    throw new Error("IsLtLock: Unable to evaluate lock without context.");
...
IsLtLock.prototype.lub = function(lock) {
    throw new Error("IsLtLock: lub not implemented for this ContractLock");
...
IsLtLock.prototype.compile2PolicyEval = function() {
    var v1 = this.args[0].compile2PolicyEval();
    var v2 = this.args[1].compile2PolicyEval();

    return v1 + " < " + v2;
}

if(global && typeof print !== "function")
    module.exports = IsLtLock;
