                                                  ...
                                                  ConstProperties
{
     ...
     *
     * @see sun.org.mozilla.javascript.ScriptableObject
     *      #put(String, Scriptable, Object)
     * @see sun.org.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see sun.org.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see sun.org.mozilla.javascript.ScriptableObject#getIds()
     * @see sun.org.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see sun.org.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see sun.org.mozilla.javascript.ScriptableObject#delete(String)
     * @see sun.org.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see sun.org.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
    ...
    public Object get(String name, Scriptable start)
    {
        ...
        {
                Provenance.addBeginFunction(slot.getValue(start).toString());
        }
        // -------------
        return slot.getValue(start);
    }
     ...
     * @see sun.org.mozilla.javascript.ScriptableObject#has(String, Scriptable)
     * @see sun.org.mozilla.javascript.ScriptableObject#READONLY
     * @see sun.org.mozilla.javascript.ScriptableObject#DONTENUM
     * @see sun.org.mozilla.javascript.ScriptableObject#PERMANENT
     * @see sun.org.mozilla.javascript.ScriptableObject#EMPTY
     */
     ...
     * @exception EvaluatorException if the named property is not found
     * @see sun.org.mozilla.javascript.Scriptable#has(String, Scriptable)
     * @see sun.org.mozilla.javascript.ScriptableObject#READONLY
     * @see sun.org.mozilla.javascript.ScriptableObject#DONTENUM
     * @see sun.org.mozilla.javascript.ScriptableObject#PERMANENT
     * @see sun.org.mozilla.javascript.ScriptableObject#EMPTY
     ...
     * @see sun.org.mozilla.javascript.Function
     * @see sun.org.mozilla.javascript.FunctionObject
     * @see sun.org.mozilla.javascript.ScriptableObject#READONLY
     * @see sun.org.mozilla.javascript.ScriptableObject
     ...
     * @see sun.org.mozilla.javascript.Scriptable#put(String, Scriptable, Object)
     */
