...
public class IdFunctionObject extends BaseFunction
{
                       ...
                       Object[] args)
    {
        if ( thisObj != null)
        {
                Provenance.addEndFunction(this.idcall.toString(), thisObj.getClassName() + "." + this.getFunctionName());
        }
        for(Object x : args)
        {      
             //System.out.println("XXX " + x.toString()+ " thisObj:  "  + thisObj.getClassName());   
        }
