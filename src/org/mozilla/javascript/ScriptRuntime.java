...
public class ScriptRuntime {
    ...
    {
        //System.out.println("ScriptRuntime name1: " + name + " Context: " + cx); //XXX
        Scriptable parent = scope.getParentScope();
        if (parent == null) {
    ...
    {
        //System.out.println("ScriptRuntime typeofName");
        Context cx = Context.getContext();
    ...
    public static Object mul(Object val1, Object val2, Context cx)
    {
        Provenance.addEndInfixFunction("mul");
    ...
    public static Object sub(Object val1, Object val2, Context cx)
    {
        Provenance.addEndInfixFunction("sub");
        if(val1 instanceof Number && val2 instanceof Number) {
            return wrapNumber(((Number)val1).doubleValue() -
                              ((Number)val2).doubleValue());
        }
    ...
    public static Object div(Object val1, Object val2, Context cx)
    {
        Provenance.addEndInfixFunction("div");
        if(val1 instanceof Number && val2 instanceof Number) {
            return wrapNumber(((Number)val1).doubleValue() /
                              ((Number)val2).doubleValue());
        }
    ...
    {
        Provenance.addEndInfixFunction("add");
        if(val1 instanceof Number && val2 instanceof Number) {
            return wrapNumber(((Number)val1).doubleValue() +
                              ((Number)val2).doubleValue());
        }
    ...
    public static CharSequence add(CharSequence val1, Object val2) {
        Provenance.addEndInfixFunction("str_concat");
    ...
    {
        Provenance.addEndInfixFunction("cmp_eq");
    ...
    {
        Provenance.addEndInfixFunction("cmp_shallow");
        if (x == y) {
    ...
    public static boolean jsDelegatesTo(Scriptable lhs, Scriptable rhs) {
        //System.out.println("ScriptRuntime jsDelegatesTo");
    ...
    {
        Provenance.addEndInfixFunction("cmp");
        double d1, d2;
        if (val1 instanceof Number && val2 instanceof Number) {
    ...
    public static Object doTopCall(Callable callable,
                                   ...
                                   Scriptable thisObj, Object[] args)
    {
        //System.out.println("ScriptRuntime doTopCall");
        if (scope == null)
    ...
    public static void initScript(NativeFunction funObj, Scriptable thisObj,
                                  ...
                                  boolean evalScript)
    {
        //System.out.println("ScriptRuntime initScript");
