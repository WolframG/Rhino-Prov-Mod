...
class BodyCodegen
{
    ...
    private void generateExpression(Node node, Node parent)
    {
        ...
        switch (type) {
              ...
              case Token.OR:
                   System.out.println("This token OR in Codegen");
              case Token.AND: {
                   System.out.println("This token AND in Codegen");
                    generateExpression(child, node);
                    cfw.add(ByteCode.DUP);
              ...
              case Token.DIV:
                ...
                generateExpression(child.getNext(), node);
                cfw.addALoad(contextLocal);
                addScriptRuntimeInvoke("div",
                "(Ljava/lang/Object;"
                +"Ljava/lang/Object;"
                +"Lorg/mozilla/javascript/Context;"
                +")Ljava/lang/Object;");
                break;
                // Before provenance there was nothing here
              case Token.MOD:
              ...
              case Token.BITOR:
                   System.out.println("This is token bitor in Codegen");
              case Token.BITXOR:
              case Token.BITAND:
              case Token.LSH:
              case Token.RSH:
