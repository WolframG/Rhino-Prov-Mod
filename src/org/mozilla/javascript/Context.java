...
public class Context
{
    ...
    public Context()
    {
        ...
        System.out.println("Modified Rhino with provenance");
    }
                                       ...
                                       Object securityDomain)
    {
        ...
        Script script = compileString(source, sourceName, lineno,
                                      securityDomain);
        if (script != null) {
             Provenance.addResult(script.exec(this, scope)); //return 
        } else {
           return null;
        }
        Provenance.endProgram();
        return (Object) Provenance.getReturnValue();
    }
