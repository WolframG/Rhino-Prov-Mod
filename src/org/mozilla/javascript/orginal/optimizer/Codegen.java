...
package org.mozilla.javascript.orginal.optimizer;

import org.mozilla.javascript.orginal.*;
import org.mozilla.javascript.orginal.ast.FunctionNode;
import org.mozilla.javascript.orginal.ast.Jump;
import org.mozilla.javascript.orginal.ast.Name;
import org.mozilla.javascript.orginal.ast.ScriptNode;
import org.mozilla.classfile.*;

import java.util.*;
import java.lang.reflect.Constructor;

import static org.mozilla.javascript.orginal.classfile.ClassFileWriter.ACC_FINAL;
import static org.mozilla.javascript.orginal.classfile.ClassFileWriter.ACC_PRIVATE;
import static org.mozilla.javascript.orginal.classfile.ClassFileWriter.ACC_PUBLIC;
import static org.mozilla.javascript.orginal.classfile.ClassFileWriter.ACC_STATIC;
import static org.mozilla.javascript.orginal.classfile.ClassFileWriter.ACC_VOLATILE;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "org.mozilla.javascript.orginal.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("org.mozilla.javascript.orginal/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org.mozilla.javascript.orginal/BaseFunction",
                      "createObject",
                      "(Lorg.mozilla.javascript.orginal/Context;"
                      +"Lorg.mozilla.javascript.orginal/Scriptable;"
                      +")Lorg.mozilla.javascript.orginal/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "org.mozilla.javascript.orginal/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "org.mozilla.javascript.orginal/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.mozilla.javascript.orginal/ScriptRuntime",
                      "hasTopCall",
                      "(Lorg.mozilla.javascript.orginal/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.mozilla.javascript.orginal/ScriptRuntime",
                      "doTopCall",
                      "(Lorg.mozilla.javascript.orginal/Callable;"
                      +"Lorg.mozilla.javascript.orginal/Context;"
                      +"Lorg.mozilla.javascript.orginal/Scriptable;"
                      +"Lorg.mozilla.javascript.orginal/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lorg.mozilla.javascript.orginal/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org.mozilla.javascript.orginal/NativeFunction",
                      "initScriptFunction",
                      "(Lorg.mozilla.javascript.orginal/Context;"
                      +"Lorg.mozilla.javascript.orginal/Scriptable;"
                      +")V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lorg.mozilla.javascript.orginal/Context;"
                      +")Lorg.mozilla.javascript.orginal/RegExpProxy;");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "org.mozilla.javascript.orginal/RegExpProxy",
                              "compileRegExp",
                              "(Lorg.mozilla.javascript.orginal/Context;"
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "org.mozilla.javascript.orginal/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "org.mozilla.javascript.orginal/Undefined",
    ...
    String getBodyMethodSignature(ScriptNode n)
    {
        ...
        sb.append("Lorg.mozilla.javascript.orginal/Context;"
                  +"Lorg.mozilla.javascript.orginal/Scriptable;"
                  +"Lorg.mozilla.javascript.orginal/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
    ...
    static final String REGEXP_INIT_METHOD_SIGNATURE
        =  "(Lorg.mozilla.javascript.orginal/Context;)V";
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lorg.mozilla.javascript.orginal/Scriptable;"
          +"Lorg.mozilla.javascript.orginal/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
        ...
        if (fnCurrent != null)
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "org.mozilla.javascript.orginal/Scriptable",
                          "getParentScope",
                          "()Lorg.mozilla.javascript.orginal/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lorg.mozilla.javascript.orginal/NativeFunction;"
                               +"Lorg.mozilla.javascript.orginal/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Lorg.mozilla.javascript.orginal/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lorg.mozilla.javascript.orginal/NativeFunction;"
                               +"Lorg.mozilla.javascript.orginal/Scriptable;"
                               +"Lorg.mozilla.javascript.orginal/Scriptable;II"
                               +")Lorg.mozilla.javascript.orginal/Scriptable;");
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "org.mozilla.javascript.orginal/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lorg.mozilla.javascript.orginal/Context;"
                    +")Lorg.mozilla.javascript.orginal/Ref;");
                break;
    ...
    private void generateArrayLiteralFactory(Node node, int count) {
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Lorg.mozilla.javascript.orginal/Context;"
                +"Lorg.mozilla.javascript.orginal/Scriptable;"
                +"Lorg.mozilla.javascript.orginal/Scriptable;"
                +"[Ljava/lang/Object;"
                +")Lorg.mozilla.javascript.orginal/Scriptable;",
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lorg.mozilla.javascript.orginal/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lorg.mozilla.javascript.orginal/Scriptable;"
                            +"Lorg.mozilla.javascript.orginal/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lorg.mozilla.javascript.orginal/Callable;"
                            +"Lorg.mozilla.javascript.orginal/Scriptable;"
                            +"Lorg.mozilla.javascript.orginal/Context;"
                            +"Lorg.mozilla.javascript.orginal/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "org.mozilla.javascript.orginal/Callable",
                "call",
                "(Lorg.mozilla.javascript.orginal/Context;"
                +"Lorg.mozilla.javascript.orginal/Scriptable;"
                +"Lorg.mozilla.javascript.orginal/Scriptable;"
    ...
    private String exceptionTypeToName(int exceptionType)
    {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "org.mozilla.javascript.orginal/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "org.mozilla.javascript.orginal/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "org.mozilla.javascript.orginal/EcmaError";
