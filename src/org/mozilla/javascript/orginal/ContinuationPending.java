...
/**
 * Exception thrown by
 * {@link org.mozilla.javascript.orginal.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link org.mozilla.javascript.orginal.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link org.mozilla.javascript.orginal.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link org.mozilla.javascript.orginal.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link org.mozilla.javascript.orginal.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link org.mozilla.javascript.orginal.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link org.mozilla.javascript.orginal.Context#resumeContinuation(Object, Scriptable, Object)}.
