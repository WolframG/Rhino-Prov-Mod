...
import org.mozilla.javascript.orginal.ast.AstRoot;
import org.mozilla.javascript.orginal.ast.ScriptNode;
import org.mozilla.javascript.orginal.debug.DebuggableScript;
import org.mozilla.javascript.orginal.debug.Debugger;
import org.mozilla.javascript.orginal.xml.XMLLib;
...
public class Context
{
    ...
    public Context()
    {
        ...
        System.out.println("Orginal Rhino no modifikation");
    }
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(org.mozilla.javascript.orginal.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "org.mozilla.javascript.orginal.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "org.mozilla.javascript.orginal.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(org.mozilla.javascript.orginal.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see org.mozilla.javascript.orginal.ErrorReporter
     */
     ...
     * @see org.mozilla.javascript.orginal.SecurityController
     */
    public final Object evaluateString(Scriptable scope, String source,
                                       String sourceName, int lineno,
                                       Object securityDomain)
    {
        System.out.println("Orginial Rhino with NO provenance");
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (org.mozilla.javascript.orginal.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see org.mozilla.javascript.orginal.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "org.mozilla.javascript.orginal.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "org.mozilla.javascript.orginal.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "org.mozilla.javascript.orginal.regexp.RegExpImpl");
            if (cl != null) {
