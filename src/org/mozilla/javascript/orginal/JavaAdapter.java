...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Lorg.mozilla.javascript.orginal/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lorg.mozilla.javascript.orginal/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lorg.mozilla.javascript.orginal/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName, Constructor<?> superCtor)
    {
        ...
        if (parameters.length == 0) {
            cfw.startMethod("<init>",
                        ...
                        +"Lorg.mozilla.javascript.orginal/ContextFactory;)V",
            ...
            StringBuilder sig = new StringBuilder(
                    "(Lorg.mozilla.javascript.orginal/Scriptable;"
                    +"Lorg.mozilla.javascript.orginal/ContextFactory;");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.mozilla.javascript.orginal/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.mozilla.javascript.orginal/JavaAdapter",
                      "runScript",
                      "(Lorg.mozilla.javascript.orginal/Script;"
                      +")Lorg.mozilla.javascript.orginal/Scriptable;");
                                     ...
                                     boolean callConvertResult)
    {
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                          "org.mozilla.javascript.orginal/Context",
                                       ...
                                       Class<?> returnType, boolean convertResult)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "(Lorg.mozilla.javascript.orginal/Scriptable;"
                      +"Ljava/lang/String;"
                      +")Lorg.mozilla.javascript.orginal/Function;");
