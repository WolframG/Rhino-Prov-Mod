...
import org.mozilla.javascript.orginal.v8dtoa.FastDtoa;
import org.mozilla.javascript.orginal.xml.XMLObject;
...
public class ScriptRuntime {
    ...
    public final static Class<?>
        ContextClass
            = Kit.classOrNull("org.mozilla.javascript.orginal.Context"),
        ContextFactoryClass
            = Kit.classOrNull("org.mozilla.javascript.orginal.ContextFactory"),
        FunctionClass
            = Kit.classOrNull("org.mozilla.javascript.orginal.Function"),
        ScriptableObjectClass
            = Kit.classOrNull("org.mozilla.javascript.orginal.ScriptableObject");
                                                       ...
                                                       boolean sealed)
    {
        ...
        new LazilyLoadedCtor(scope, "RegExp",
                "org.mozilla.javascript.orginal.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(scope, "Packages",
                "org.mozilla.javascript.orginal.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "getClass",
                "org.mozilla.javascript.orginal.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "JavaAdapter",
                "org.mozilla.javascript.orginal.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(scope, "JavaImporter",
                "org.mozilla.javascript.orginal.ImporterTopLevel", sealed, true);
        new LazilyLoadedCtor(scope, "Continuation",
                "org.mozilla.javascript.orginal.NativeContinuation", sealed, true);
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "org.mozilla.javascript.orginal.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource
                = "org.mozilla.javascript.orginal.resources.Messages";
