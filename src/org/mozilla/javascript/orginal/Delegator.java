...
public class Delegator implements Function {
     ...
     *
     * @see org.mozilla.javascript.orginal.Delegator#construct
     */
    public Delegator() {
    }
    ...
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#getClassName
     */
    public String getClassName() {
        return obj.getClassName();
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#get(String, Scriptable)
     */
    public Object get(String name, Scriptable start) {
        return obj.get(name,start);
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#get(int, Scriptable)
     */
    ...
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#has(int, Scriptable)
     */
    ...
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#put(int, Scriptable, Object)
     */
    public void put(int index, Scriptable start, Object value) {
        obj.put(index,start,value);
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#delete(String)
     */
    public void delete(String name) {
        obj.delete(name);
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#delete(int)
     */
    public void delete(int index) {
        obj.delete(index);
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#getPrototype
     */
    public Scriptable getPrototype() {
        return obj.getPrototype();
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#setPrototype
     */
    public void setPrototype(Scriptable prototype) {
        obj.setPrototype(prototype);
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#getParentScope
     */
    public Scriptable getParentScope() {
        return obj.getParentScope();
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#setParentScope
     */
    public void setParentScope(Scriptable parent) {
        obj.setParentScope(parent);
    }
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#getIds
     */
     ...
     *
     * @see org.mozilla.javascript.orginal.Scriptable#getDefaultValue
     */
    ...
    /**
     * @see org.mozilla.javascript.orginal.Scriptable#hasInstance
     */
    public boolean hasInstance(Scriptable instance) {
        return obj.hasInstance(instance);
    }
    /**
     * @see org.mozilla.javascript.orginal.Function#call
     */
