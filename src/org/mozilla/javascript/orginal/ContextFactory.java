...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link org.mozilla.javascript.orginal.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected org.mozilla.javascript.orginal.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return org.mozilla.javascript.orginal.xml.XMLLib.Factory.create(
                "org.mozilla.javascript.orginal.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return org.mozilla.javascript.orginal.xml.XMLLib.Factory.create(
                "org.mozilla.javascript.orginal.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
